...
export const Header = () => {
    ...
    const { person, home, about, experience, projects, contact } = renderContent(t);
                ...
                <Flex
                    ...
                    {routes['/experience'] && (
                        <ToggleButton
                            ...
                            <Flex paddingX="2" hide="s">{experience.label}</Flex>
                        </ToggleButton>
                    )}
                    {routes['/projects'] && (
                        <ToggleButton
                    ...
                    {routes['/skills'] && (
                        <ToggleButton
                            ...
                            <Flex paddingX="2" hide="s">Skills</Flex>
                        </ToggleButton>
                    )}
                    {routes['/gallery'] && (
                        <ToggleButton
                            ...
                            <Flex paddingX="2" hide="s">Gallery</Flex>
                        </ToggleButton>
                    )}
                    {routes['/contact'] && (
                        <ToggleButton
